...
contract('StabilityPool - Withdrawal of stability deposit - Reward calculations', async accounts => {
  ...
  describe("Stability Pool Withdrawal", async () => {
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and BNB Gain after one liquidation", async () => {
      ...
      const txB = await stabilityPool.withdrawFromSP(dec(10000, 18), DEFAULT_PRICE_FEED_DATA, { from: bob })
      const txC = await stabilityPool.withdrawFromSP(dec(10000, 18), DEFAULT_PRICE_FEED_DATA, { from: carol })
      ...
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(alice)).toString(), '6666666666666666666666'), 10000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(bob)).toString(), '6666666666666666666666'), 10000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(carol)).toString(), '6666666666666666666666'), 10000)
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and BNB Gain after two identical liquidations", async () => {
      // Whale opens Trove with 100k BNB
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(100000, 18)), whale, whale, DEFAULT_PRICE_FEED_DATA, { from: whale, value: dec(100000, 'ether') })
      ...
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(alice)).toString(), '3333333333333333333333'), 10000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(bob)).toString(), '3333333333333333333333'), 10000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(carol)).toString(), '3333333333333333333333'), 10000)
    ...
    it("withdrawFromSP():  Depositors with equal initial deposit withdraw correct compounded deposit and BNB Gain after three identical liquidations", async () => {
      // Whale opens Trove with 100k BNB
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(100000, 18)), whale, whale, DEFAULT_PRICE_FEED_DATA, { from: whale, value: dec(100000, 'ether') })
      ...
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(alice)).toString(), '0'), 10000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(bob)).toString(), '0'), 10000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(carol)).toString(), '0'), 10000)
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and BNB Gain after two liquidations of increasing USDS", async () => {
      // Whale opens Trove with 100k BNB
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(100000, 18)), whale, whale, DEFAULT_PRICE_FEED_DATA, { from: whale, value: dec(100000, 'ether') })
      ...
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(alice)).toString(), '6000000000000000000000'), 10000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(bob)).toString(), '6000000000000000000000'), 10000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(carol)).toString(), '6000000000000000000000'), 10000)
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and BNB Gain after three liquidations of increasing USDS", async () => {
      // Whale opens Trove with 100k BNB
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(100000, 18)), whale, whale, DEFAULT_PRICE_FEED_DATA, { from: whale, value: dec(100000, 'ether') })
      ...
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(alice)).toString(), '4000000000000000000000'), 10000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(bob)).toString(), '4000000000000000000000'), 10000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(carol)).toString(), '4000000000000000000000'), 10000)
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and BNB Gain after two identical liquidations", async () => {
      // Whale opens Trove with 100k BNB
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(100000, 18)), whale, whale, DEFAULT_PRICE_FEED_DATA, { from: whale, value: dec(100000, 'ether') })
      ...
      const txA = await stabilityPool.withdrawFromSP(dec(10000, 18), DEFAULT_PRICE_FEED_DATA, { from: alice })
      const txB = await stabilityPool.withdrawFromSP(dec(20000, 18), DEFAULT_PRICE_FEED_DATA, { from: bob })
      const txC = await stabilityPool.withdrawFromSP(dec(30000, 18), DEFAULT_PRICE_FEED_DATA, { from: carol })
      ...
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(alice)).toString(), '6666666666666666666666'), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(bob)).toString(), '13333333333333333333333'), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(carol)).toString(), '20000000000000000000000'), 100000)
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and BNB Gain after three identical liquidations", async () => {
      // Whale opens Trove with 100k BNB
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(100000, 18)), whale, whale, DEFAULT_PRICE_FEED_DATA, { from: whale, value: dec(100000, 'ether') })
      ...
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(alice)).toString(), '5000000000000000000000'), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(bob)).toString(), '10000000000000000000000'), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(carol)).toString(), '15000000000000000000000'), 100000)
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and BNB Gain after three varying liquidations", async () => {
      ...
      */
      ...
      // Depositors attempt to withdraw everything
      const txA = await stabilityPool.withdrawFromSP(dec(500000, 18), DEFAULT_PRICE_FEED_DATA, { from: alice })
      const txB = await stabilityPool.withdrawFromSP(dec(500000, 18), DEFAULT_PRICE_FEED_DATA, { from: bob })
      const txC = await stabilityPool.withdrawFromSP(dec(500000, 18), DEFAULT_PRICE_FEED_DATA, { from: carol })
      ...
      // ()
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(alice)).toString(), '901719380174061000000'), 100000000000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(bob)).toString(), '205592018679686000000000'), 10000000000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(carol)).toString(), '5906261940140100000000'), 10000000000)
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 1 liquidation. All deposits and liquidations = 100 USDS.  A, B, C, D withdraw correct USDS deposit and BNB Gain", async () => {
      // Whale opens Trove with 100k BNB
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(100000, 18)), whale, whale, DEFAULT_PRICE_FEED_DATA, { from: whale, value: dec(100000, 'ether') })
      ...
      console.log()
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(alice)).toString(), '1666666666666666666666'), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(bob)).toString(), '1666666666666666666666'), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(carol)).toString(), '1666666666666666666666'), 100000)

      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(dennis)).toString(), '5000000000000000000000'), 100000)
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. All deposits and liquidations = 100 USDS.  A, B, C, D withdraw correct USDS deposit and BNB Gain", async () => {
      // Whale opens Trove with 100k BNB
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(100000, 18)), whale, whale, DEFAULT_PRICE_FEED_DATA, { from: whale, value: dec(100000, 'ether') })
      ...
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(alice)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(bob)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(carol)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(dennis)).toString(), '0'), 100000)
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. Various deposit and liquidation vals.  A, B, C, D withdraw correct USDS deposit and BNB Gain", async () => {
      // Whale opens Trove with 1m BNB
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(1000000, 18)), whale, whale, DEFAULT_PRICE_FEED_DATA, { from: whale, value: dec(1000000, 'ether') })
      ...
      */
      ...
      const txA = await stabilityPool.withdrawFromSP(dec(100000, 18), DEFAULT_PRICE_FEED_DATA, { from: alice })
      const txB = await stabilityPool.withdrawFromSP(dec(100000, 18), DEFAULT_PRICE_FEED_DATA, { from: bob })
      const txC = await stabilityPool.withdrawFromSP(dec(100000, 18), DEFAULT_PRICE_FEED_DATA, { from: carol })
      const txD = await stabilityPool.withdrawFromSP(dec(100000, 18), DEFAULT_PRICE_FEED_DATA, { from: dennis })
      ...
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(alice)).toString(), '17832817337461300000000'), 100000000000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(bob)).toString(), '5944272445820430000000'), 100000000000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(carol)).toString(), '4458204334365320000000'), 100000000000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(dennis)).toString(), '11764705882352900000000'), 100000000000)
    ...
    it("withdrawFromSP(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. All deposits and liquidations = 100 USDS.  A, B, C, D withdraw correct USDS deposit and BNB Gain", async () => {
      // Whale opens Trove with 100k BNB
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(100000, 18)), whale, whale, DEFAULT_PRICE_FEED_DATA, { from: whale, value: dec(100000, 'ether') })
      ...
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(alice)).toString(), '0'), 1000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(bob)).toString(), '0'), 1000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(carol)).toString(), '0'), 1000)
    ...
    it("withdrawFromSP(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. Various deposit and liquidation vals. A, B, C, D withdraw correct USDS deposit and BNB Gain", async () => {
      // Whale opens Trove with 100k BNB
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(100000, 18)), whale, whale, DEFAULT_PRICE_FEED_DATA, { from: whale, value: dec(100000, 'ether') })
      ...
      */
      ...
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(alice)).toString(), '1672240802675590000000'), 10000000000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(bob)).toString(), '2090301003344480000000'), 100000000000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(carol)).toString(), '1045150501672240000000'), 100000000000)
    ...
    it("withdrawFromSP(): A, B, D deposit -> 2 liquidations -> C makes deposit -> 1 liquidation -> D withdraws -> 1 liquidation. All deposits: 100 USDS. Liquidations: 100,100,100,50.  A, B, C, D withdraw correct USDS deposit and BNB Gain", async () => {
      // Whale opens Trove with 100k BNB
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(100000, 18)), whale, whale, DEFAULT_PRICE_FEED_DATA, { from: whale, value: dec(100000, 'ether') })
      ...
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(alice)).toString(), '666666666666666666666'), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(bob)).toString(), '666666666666666666666'), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(carol)).toString(), '2000000000000000000000'), 100000)
    ...
    it("withdrawFromSP(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(carol)).toString(), '5000000000000000000000'), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(dennis)).toString(), '5000000000000000000000'), 100000)
    ...
    it("withdrawFromSP(): Depositors withdraw correct compounded deposit after liquidation empties the pool", async () => {
      ...
      const txB = await stabilityPool.withdrawFromSP(dec(10000, 18), DEFAULT_PRICE_FEED_DATA, { from: bob })
      const txC = await stabilityPool.withdrawFromSP(dec(10000, 18), DEFAULT_PRICE_FEED_DATA, { from: carol })
      const txD = await stabilityPool.withdrawFromSP(dec(20000, 18), DEFAULT_PRICE_FEED_DATA, { from: dennis })
      const txE = await stabilityPool.withdrawFromSP(dec(30000, 18), DEFAULT_PRICE_FEED_DATA, { from: erin })
      ...
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(carol)).toString(), '8333333333333333333333'), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(dennis)).toString(), '16666666666666666666666'), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(erin)).toString(), '25000000000000000000000'), 100000)
    ...
    it("withdrawFromSP(): single deposit fully offset. After subsequent liquidations, depositor withdraws 0 deposit and *only* the BNB Gain from one liquidation", async () => {
      // Whale opens Trove with 100k BNB
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(100000, 18)), whale, whale, DEFAULT_PRICE_FEED_DATA, { from: whale, value: dec(100000, 'ether') })
    ...
    it("withdrawFromSP(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      const txC = await stabilityPool.withdrawFromSP(dec(10000, 18), DEFAULT_PRICE_FEED_DATA, { from: carol })
      const txD = await stabilityPool.withdrawFromSP(dec(10000, 18), DEFAULT_PRICE_FEED_DATA, { from: dennis })
      const txE = await stabilityPool.withdrawFromSP(dec(10000, 18), DEFAULT_PRICE_FEED_DATA, { from: erin })
      const txF = await stabilityPool.withdrawFromSP(dec(10000, 18), DEFAULT_PRICE_FEED_DATA, { from: flyn })
      const txG = await stabilityPool.withdrawFromSP(dec(10000, 18), DEFAULT_PRICE_FEED_DATA, { from: graham })
      const txH = await stabilityPool.withdrawFromSP(dec(10000, 18), DEFAULT_PRICE_FEED_DATA, { from: harriet })
      ...
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(carol)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(dennis)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(erin)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(flyn)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(graham)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(harriet)).toString(), '0'), 100000)
    ...
    it("withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and BNB Gain after one liquidation", async () => {
      // Whale opens Trove with 100k BNB
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(100000, 18)), whale, whale, DEFAULT_PRICE_FEED_DATA, { from: whale, value: dec(100000, 'ether') })
      ...
      // Expect Bob to withdraw 1% of initial deposit (100 USDS) and all the liquidated BNB (60 ether)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(bob)).toString(), '100000000000000000000'), 100000)
    ...
    // expect d(B) = d0(B)/100
    // expect correct BNB gain, i.e. all of the reward
    it("withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraw correct compounded deposit and BNB Gain after one liquidation", async () => {
      // Whale opens Trove with 100k BNB
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(100000, 18)), whale, whale, DEFAULT_PRICE_FEED_DATA, { from: whale, value: dec(100000, 'ether') })
      ...
      const txB = await stabilityPool.withdrawFromSP(dec(10000, 18), DEFAULT_PRICE_FEED_DATA, { from: bob })
      const txC = await stabilityPool.withdrawFromSP(dec(20000, 18), DEFAULT_PRICE_FEED_DATA, { from: carol })
      const txD = await stabilityPool.withdrawFromSP(dec(30000, 18), DEFAULT_PRICE_FEED_DATA, { from: dennis })

      /* Expect depositors to withdraw 1% of their initial deposit, and an BNB gain 
      ...
      */
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(bob)).toString(), dec(100, 18)), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(carol)).toString(), dec(200, 18)), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(dennis)).toString(), dec(300, 18)), 100000)
    ...
    it("withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and BNB Gain after one liquidation", async () => {
      ...
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(bob)).toString(), dec(1, 17)), 100000)
    ...
    // expect d(B) = d0(B) * 1e-5
    // expect B gets entire BNB gain from L2
    it("withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraws correct compounded deposit and BNB Gain after one liquidation", async () => {
      // Whale opens Trove with 100k BNB
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(100000, 18)), whale, whale, DEFAULT_PRICE_FEED_DATA, { from: whale, value: dec(100000, 'ether') })
      ...
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(bob)).toString(), dec(1, 17)), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(carol)).toString(), dec(2, 17)), 100000)
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(dennis)).toString(), dec(3, 17)), 100000)
    ...
    */
    it("withdrawFromSP(): Several deposits of 10000 USDS span one scale factor change. Depositors withdraws correct compounded deposit and BNB Gain after one liquidation", async () => {
      // Whale opens Trove with 100k BNB
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(100000, 18)), whale, whale, DEFAULT_PRICE_FEED_DATA, { from: whale, value: dec(100000, 'ether') })
      ...
      assert.equal(await usdsToken.balanceOf(alice), '0')
      assert.equal(await usdsToken.balanceOf(alice), '0')
      assert.equal(await usdsToken.balanceOf(alice), '0')
      // D should withdraw around 0.9999 USDS, since his deposit of 9999.9 was reduced by a factor of 1e-5
      assert.isAtMost(th.getDifference((await usdsToken.balanceOf(dennis)).toString(), dec(99999, 12)), 100000)
    ...
    it("withdrawFromSP(): 2 depositors can withdraw after each receiving half of a pool-emptying liquidation", async () => {
      ...
      // Increasing the price for a moment to avoid pending liquidations to block withdrawal
      await priceFeed.setPrice(dec(200, 18))
      const txA = await stabilityPool.withdrawFromSP(dec(1000, 18), DEFAULT_PRICE_FEED_DATA, { from: A })
      const txB = await stabilityPool.withdrawFromSP(dec(1000, 18), DEFAULT_PRICE_FEED_DATA, { from: B })
      await priceFeed.setPrice(dec(100, 18))
      ...
      // Increasing the price for a moment to avoid pending liquidations to block withdrawal
      await priceFeed.setPrice(dec(200, 18))
      const txC = await stabilityPool.withdrawFromSP(dec(1000, 18), DEFAULT_PRICE_FEED_DATA, { from: C })
      const txD = await stabilityPool.withdrawFromSP(dec(1000, 18), DEFAULT_PRICE_FEED_DATA, { from: D })
      await priceFeed.setPrice(dec(100, 18))
      ...
      // Attempt withdrawals
      const txE = await stabilityPool.withdrawFromSP(dec(1000, 18), DEFAULT_PRICE_FEED_DATA, { from: E })
      const txF = await stabilityPool.withdrawFromSP(dec(1000, 18), DEFAULT_PRICE_FEED_DATA, { from: F })
      assert.isTrue(txE.receipt.status)
      assert.isTrue(txF.receipt.status)
    })

    it("withdrawFromSP(): Depositor's BNB gain stops increasing after two scale changes", async () => {
      // Whale opens Trove with 100k BNB
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(100000, 18)), whale, whale, DEFAULT_PRICE_FEED_DATA, { from: whale, value: dec(100000, 'ether') })

      // Defaulters 1-5 each withdraw up to debt of 9999.9999999 USDS
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(99999, 17)), defaulter_1, defaulter_1, DEFAULT_PRICE_FEED_DATA, { from: defaulter_1, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(99999, 17)), defaulter_2, defaulter_2, DEFAULT_PRICE_FEED_DATA, { from: defaulter_2, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(99999, 17)), defaulter_3, defaulter_3, DEFAULT_PRICE_FEED_DATA, { from: defaulter_3, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(99999, 17)), defaulter_4, defaulter_4, DEFAULT_PRICE_FEED_DATA, { from: defaulter_4, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(99999, 17)), defaulter_5, defaulter_5, DEFAULT_PRICE_FEED_DATA, { from: defaulter_5, value: dec(100, 'ether') })
      ...
      const alice_BNBGainAt2ndScaleChange = (await stabilityPool.getDepositorBNBGain(alice)).toString()

      // E deposits 9999.9 USDS
      await usdsToken.transfer(erin, dec(99999, 17), { from: whale })
      ...
      const alice_BNBGainAfterFurtherLiquidation = (await stabilityPool.getDepositorBNBGain(alice)).toString()
  
      const alice_scaleSnapshot = (await stabilityPool.depositSnapshots(alice))[2].toString()

      assert.equal(alice_scaleSnapshot, '0')
      assert.equal(alice_BNBGainAt2ndScaleChange, alice_BNBGainAfterFurtherLiquidation)
    })

    // --- Extreme values, confirm no overflows ---

    it("withdrawFromSP(): Large liquidated coll/debt, deposits and BNB price", async () => {
      // Whale opens Trove with 100k BNB
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(100000, 18)), whale, whale, DEFAULT_PRICE_FEED_DATA, { from: whale, value: dec(100000, 'ether') })
      ...
      const txA = await stabilityPool.withdrawFromSP(dec(1, 36), DEFAULT_PRICE_FEED_DATA, { from: alice })
      const txB = await stabilityPool.withdrawFromSP(dec(1, 36), DEFAULT_PRICE_FEED_DATA, { from: bob })
      ...
      const bobUSDSBalance = await usdsToken.balanceOf(bob)
    ...
    it("withdrawFromSP(): Small liquidated coll/debt, large deposits and BNB price", async () => {
      // Whale opens Trove with 100k BNB
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveUSDSAmount(dec(100000, 18)), whale, whale, DEFAULT_PRICE_FEED_DATA, { from: whale, value: dec(100000, 'ether') })
      ...
      const txA = await stabilityPool.withdrawFromSP(dec(1, 38), DEFAULT_PRICE_FEED_DATA, { from: alice })
      const txB = await stabilityPool.withdrawFromSP(dec(1, 38), DEFAULT_PRICE_FEED_DATA, { from: bob })
      ...
      assert.equal(alice_BNBWithdrawn.toString(), '0')
      assert.equal(bob_BNBWithdrawn.toString(), '0')
    })
  })
})
