...
//     console.log(`Testnet: Latest BNB:USD price from aggregator: ${price_aggregatorTestnet}`);
...
//     console.log(`Testnet: Latest BNB:USD price from deployed PriceFeed: ${price_PriceFeedTestnet}`)
...
//     console.log(`Mainnet: Latest BNB:USD price from aggregator: ${price_aggregatorMainnet}`);
...
//     console.log(`Mainnet: Latest BNB:USD price from deployed PriceFeed: ${price_PriceFeedMainnet}`)
